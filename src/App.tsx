...
const TYPED_LINES = [
   "> miiu oiiiiii",
   "...",
   "> Happy birthday my pwetti lil babiii",
   "...",
...
function AnimatedScene({
   ...
   return (
      <>
         ...
         <group ref={cakeGroup}>
            <Cake position={[-0.6, 0, -0.2]} />
            {/* <pointLight */}
            {/*    position={[0, 2, 0]} */}
            {/*    intensity={3 * environmentProgress} // Fades in with the background! */}
            {/*    distance={5} */}
            {/*    color="#fff5e6" // A slightly warm, creamy white */}
            {/* /> */}
         </group>
         <group ref={candleGroup}>
            <Candle isLit={candleLit} scale={0.25} position={[0, 2.2, 0]} />
         </group>
      </>
   );
}
         ...
         >
            <Suspense fallback={null}>
               ...
               <Environment
                  ...
                  background
                  environmentIntensity={0.53 * environmentProgress}
                  backgroundIntensity={0.53 * environmentProgress}
               />
               <EnvironmentBackgroundController intensity={0.53 * environmentProgress} />
